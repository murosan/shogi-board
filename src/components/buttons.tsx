        ...
        <div className={'btn-area'}>
          <div className={'btn-row'}>
            <button className={'btn'}
              onClick={() => this.props.changeIndexByDiff(-1)}>＜</button>
            <button className={'btn'}
              onClick={() => this.props.changeIndexByDiff(1)}>＞</button>
          </div>
          <div className={'btn-row'}>
            <button className={'btn'}
              onClick={() => this.props.changeIndexByDiff(-5)}>＜ 5</button>
            <button className={'btn'}
              onClick={() => this.props.changeIndexByDiff(5)}>5 ＞</button>
          </div>
          <div className={'btn-row'}>
          ...
          <div className={'btn-row'}>
            <button className={'btn'}
              onClick={() => this.props.upsidedown()}>盤面反転</button>
          </div>
          <div className={'btn-row'}>
            <button className={'btn'}
              onClick={() => this.props.copyKif()}>棋譜コピー</button>
          </div>
        </div>
      </div>
    );
