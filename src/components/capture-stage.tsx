...
import { setStyles } from '../fn/cap-styles';
...
export default class CaptureStage extends React.Component<CaptureStageProps, {}> {
  renderCapPiece(whose: number, name: string) {
    const elms = [];
        ...
        if (caps) {
          ...
          elms.push(
            <PieceElm
              ...
              styles={setStyles(len, count, len - count, name, whoseForStyle)}
            />
          );
        }
      }
