...
export default function movings(props: MovProps): Array<PieceObj | EmpObj> {
  ...
  if (name === '歩') { return movFu(props); }
  else if (name === '香') { return movKy(props); }
  else if (name === '桂') { return movKe(props); }
  else if (name === '銀') { return movGi(props); }
  else if (name === '金') { return movKi(props); }
  else if (name === '角') { return movKa(props); }
  else if (name === '飛') { return movHi(props); }
  else if (name === '玉') { return movGy(props); }
  else /* name === '馬' || name === '龍' */ {
